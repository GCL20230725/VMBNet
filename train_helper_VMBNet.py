...
def train_collate_jhu(batch):
    ...
    return images, points, targets, st_sizes, gt_discretes
...
class Trainer(object):
    ...
    def setup(self):
        ...
        self.vmamba_config = get_config(args)
        self.model = build_vssm_model(self.vmamba_config)
    ...
    def train_epoch(self):
        ...
        # for step, (inputs, points, targets, st_sizes, gt_discrete) in enumerate(self.dataloaders['train']):
